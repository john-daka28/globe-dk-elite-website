      ...
      <div className="sticky top-0 z-30 flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3 lg:hidden">
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#10243d] text-white shadow-sm"
        ...
        <div className="flex items-center gap-2 rounded-xl bg-[#f4f1ea] px-3 py-2">
